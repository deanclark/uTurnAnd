package com.crystalwink.crystals.TileAdapter;

import com.crystalwink.crystalscommon.Tile.Tile;

import com.crystalwink.uturn.R;
...
public class TileAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) { // if it's not recycled, initialise some
			...
			imageView.setLayoutParams(new GridView.LayoutParams(Tile.getSegmentScale(), Tile.getSegmentScale()));  // tile scale
